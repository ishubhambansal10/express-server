...
*/
 ...
 .post('/', authMiddleWare(Users, 'write'), validationHandler(validation.create), UserRoutes.create)
...
*/
 ...
 .put('/', authMiddleWare(Users, 'write'), validationHandler(validation.update), UserRoutes.update)
